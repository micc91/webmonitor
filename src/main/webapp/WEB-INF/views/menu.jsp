<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active"><a class="nav-link" href="<c:url value='/index'/>">Home <span class="sr-only">(current)</span></a></li>
...
-->
      ...
      <li class="nav-item"><a class="nav-link ${loginstatus}"  href="<c:url value='/login'/>"    >Login</a></li>
      <li class="nav-item"><a class="nav-link ${logoutstatus}" href="<c:url value='/dashboard'/>">Dashboard</a></li>
      <li class="nav-item"><a class="nav-link ${logoutstatus}" href="<c:url value='/logout'/>"   >Logout</a></li>
    </ul>
