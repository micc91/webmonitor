...
<footer class="fixed-bottom bg-dark footer mt-auto py-3">
    <div class="container">
                <span class="text-muted">
                    <c:if test="${ !empty sessionScope.uvmsConnection.login }"><p><c:out
                            value="Connection string:${uvmsConnection.login}:####@${uvmsConnection.uvmsHost}:${uvmsConnection.uvmsPort} => ${uvmsConnection.token}"/></p>
                    </c:if>
                </span>
    </div>
</footer>
