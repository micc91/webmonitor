    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 ">
            <div class="jumbotron container-lg ">
                ...
                <form class="form-signin" action="./rerun" method="post" >
                    <div class="row mb-3">
                        <div class="col-md-8 themed-grid-col">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 themed-grid-col">
                                    ...
                                    <c:if test="${empty currentTask}"><c:set var="currentTask" value="${requestScope.jobInfo[0].task}"/></c:if>
                                    <input type="text" size="20" maxlength="64" class="form-control" id="inputTask" name="inputTask" value="${param.task}" readonly />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-4 themed-grid-col">
                                ...
                                <div class="col-md-8 themed-grid-col">
                                    ...
                                    <c:if test="${empty currentMu}"><c:set var="currentMu" value="${requestScope.jobInfo[0].mu}"/></c:if>
                                    <input type="text" size="20" maxlength="64" class="form-control" id="inputMu" name="inputMu" value="${param.mu}" readonly />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-4 themed-grid-col">
                                ...
                                <div class="col-md-8 themed-grid-col">
                                    ...
                                    <c:if test="${empty currentSession}"><c:set var="currentSession" value="${requestScope.jobInfo[0].session}"/></c:if>
                                    <input type="text" size="20" maxlength="64" class="form-control" id="inputSession" name="inputSession" value="${param.session}" readonly />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-4 themed-grid-col">
                                ...
                                <div class="col-md-8 themed-grid-col">
                                    ...
                                    <c:if test="${empty currentUproc}"><c:set var="currentUproc" value="${requestScope.jobInfo[0].uproc}"/></c:if>
                                    <input type="text" size="20" maxlength="64" class="form-control" id="inputUproc" name="inputUproc" value="${param.uproc}" readonly />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 themed-grid-col">
                    ...
                    <div class="row mb-3" >
                        <div class="col-md-6 themed-grid-col">
                            ...
                            <c:if test="${empty currentQueue}"><c:set var="currentQueue" value="${requestScope.jobInfo[0].queue}"/></c:if>
                            <input type="text" id="inputQueue" name="inputQueue" value="${param.queue}" size="20" maxlength="64" class="form-control" placeholder="Batch Queue name" required />
                        ...
                        <div class="col-md-6 themed-grid-col">
                            ...
                            <c:if test="${empty currentUser}"><c:set var="currentUser" value="${requestScope.jobInfo[0].user}"/></c:if>
                            <c:if test="${empty currentUser}"><c:set var="currentUser" value="${settings.submissionAccount}"/></c:if>
                            <input type="text" id="inputUser" name="inputUser" value="${param.user}" size="20" maxlength="64" class="form-control" placeholder="User name" required />
                        ...
                        <div class="col-md-6 themed-grid-col">
                            ...
                            <input type="text" id="inputInfo" name="inputInfo" value="${currentInfo}" size="20" maxlength="64" class="form-control" placeholder="Information" />
                            <span class="error-msg">${errors['inputInfo']}</span>
                        </div>
                        <div class="col-md-6 themed-grid-col">
                            <label for="inputPriority" >Priority</label>
                            <c:set var="currentPriority" value="${param.priority}"/>
                            <c:if test="${empty currentPriority}"><c:set var="currentPriority" value="${requestScope.jobInfo[0].priority}"/></c:if>
                            <input type="text" id="inputPriority" name="inputPriority" value="${currentPriority}" size="20" maxlength="64" class="form-control" placeholder="[1-100]" required>
                        ...
                        <div class="col-md-6 themed-grid-col">
                            ...
                            <c:if test="${empty currentPdate}"><c:set var="currentPdate" value="${requestScope.jobInfo[0].pdate}"/></c:if>
                    ...
                    <button class="btn btn-lg btn-primary btn-block" type="submit" id="btn-re-run" onclick="animateLoading('btn-re-run');" >Re-Run</button>
                </form>
            </div>
        </main>
    </div>
